...
<body>
	...
	<form action="newFilm.do" method="POST">
		...
		<label for="newTitle">Enter the Film Title:</label> <input type="text"
			id="newTitle" name="newTitle" required><br> <br>
		...
		<label for="newDescription">Enter the Film Description:</label> <input
			type="text" id="newDescription" name="newDescription" size="90"
			required><br> <br>
		...
		<label for="year">Select the Year the Film Was Released:</label> <input
			type="number" id="year" name="newReleaseYear" min="1930" max="2024"
			value="2024"><br> <br>
		...
		<input type="radio" id="LanguageId" name="languageId" value="English"
			required> <label for="LanguageId">1.)
			English</label><br> <input type="radio" id="LanguageId"
			name="languageId" value="Italian"> <label for="LanguageId">2.)
			Italian</label><br> <input type="radio" id="LanguageId"
			name="languageId" value="Japanese"> <label for="LanguageId">3.)
			Japanese</label><br> <input type="radio" id="LanguageId"
			name="languageId" value="Mandarin"> <label for="LanguageId">4.)
			Mandarin</label><br> <input type="radio" id="LanguageId"
			name="languageId" value="French"> <label for="LanguageId">5.)
			French</label><br> <input type="radio" id="LanguageId" name="languageId"
			value="German"> <label for="LanguageId">6.) German</label><br>
		<br>
		...
		<input type="radio" id="rentalDuration" name="rentalDuration"
			value="2" required> <label for="rentalDuration">|
			New Release Film (Red Box): 2-day Rental Duration</label><br> <input
			type="radio" id="rentalDuration" name="rentalDuration" value="7"> <label for="rentalDuration">|
			Older Film (Blue Box): 7-day Rental Duration</label><br> <br>
		...
		<label for="rentalRate">How Much is it to Rent the Film?</label> <input
			...
			min="5.99" max="19.99" step="1.0"><br>
		<br>
		...
		<input type="radio" id="rating" name="rating" value="PG"
			required> <label for="LanguageId">1.) PG
			-- Parental Guidance Suggested</label><br> <input type="radio"
			id="rating" name="rating" value="G"> <label for="LanguageId">2.)
			G -- General Audiences (All Ages)</label><br> <input type="radio"
			id="rating" name="rating" value="NC17"> <label
