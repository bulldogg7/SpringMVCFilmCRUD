...
<body>
	...
	<form action="newFilm.do" method="POST">
		...
		<h3>Film Language</h3>
		<input type="radio" id="languageId" name="languageId" value="1"
			required> <label for="languageId">1.) English</label><br>

		<input type="radio" id="languageId" name="languageId" value="2">
		<label for="languageId">2.) Italian</label><br> <input
			type="radio" id="languageId" name="languageId" value="3"> <label
			for="languageId">3.) Japanese</label><br> <input type="radio"
			id="languageId" name="languageId" value="4"> <label
			for="languageId">4.) Mandarin</label><br> <input type="radio"
			id="languageId" name="languageId" value="5"> <label
			for="language_id">5.) French</label><br> <input type="radio"
			id="languageId" name="languageId" value="6"> <label
			for="languageId">6.) German</label><br> <br>
