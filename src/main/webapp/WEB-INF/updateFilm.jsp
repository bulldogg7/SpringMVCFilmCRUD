...
<body>
	...
	<form action="MovieMaker" method="post">
		...
		<h3>Film Length</h3>
		<label for="filmLength">Select how long the film is:</label> <input
			type="number" id="filmLength" name="filmLength" min="45" max="185"
			value="60" step="5"><br> <br>
		...
		<input type="radio" id="rating" name="rating" value="NC17"> <label
			for="LanguageId">3.) NC17 --No One 17 and Under Admitted</label><br>
		<input type="radio" id="rating" name="rating" value="PG13"> <label
			for="LanguageId">4.) PG13 --Parents Strongly Cautioned</label><br>
